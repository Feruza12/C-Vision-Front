...
//   var companyName = document.getElementsByName("companyName").value;
//   var problemStatement = document.getElementsByName("problemStatement").value;
//   var email = document.getElementsByName("email").value;
//   var emailReg = /^([w-.]+@([w-]+.)+[w-]{2,4})?$/;
//   if (name === '' || companyName === '' || problemStatement === '' || email === '') {
...
function check(form_id) {
  var flag;
  var arr = $(form_id + ' input, ' + form_id + ' textarea ').serializeArray();
  $.each(arr, function (i, field) {
    if (!field.value) {
      var err = $(form_id + ' input[name="' + field.name + '"]');
      var errorta = $(form_id + ' textarea[name="' + field.name + '"]');
      err.css("border-bottom", "2px solid red");
      errorta.css("border", "2px solid red");
      flag = false;
      return false;
    }
    else {
      flag = true;
      var err = $(form_id + ' input[name="' + field.name + '"]');
      err.css("border-bottom", "1px solid #D0D0D0");
    }
